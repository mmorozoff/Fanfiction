            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (_userManager.Options.SignIn.RequireConfirmedAccount)
                    {
                        ...
                        if (await _roleManager.RoleExistsAsync("blocked") == false)
                        {
                            await _roleManager.CreateAsync(new IdentityRole { Name = "blocked", NormalizedName = "BLOCKED" });
                        }

                        if (Input.Login == "maxich")
